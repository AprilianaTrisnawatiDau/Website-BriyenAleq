...
form.addEventListener("submit", async function (e) {
    ...
    const data = {
        ...
        alamat: document.getElementById("alamat").value, // ✅ TAMBAHAN KOLOM ALAMAT
...
function renderTable() {
    ...
    transaksiList.forEach((t, index) => {
        ...
        row.innerHTML = `
            ...
            <td>${t.nama}</td>
            <td>${t.produk}</td>
            <td>${t.alamat}</td> <td>${t.kategori}</td>
            <td>${t.harga}</td>
...
window.detailData = function (index) {
    ...
    // ✅ TAMBAHAN ALAMAT DI ALERT DETAIL
...
window.editData = function (index) {
    ...
    document.getElementById("alamat").value = t.alamat; // ✅ SET ALAMAT UNTUK EDIT
